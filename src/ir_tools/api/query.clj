...
and a sequence of connectors. Optional last argument is a function that
shrinks a phrase to a given maximum amount of words (possibly producing a
sequence of few new phrases."
  ([query phrase? max-words]
     (divide-query query phrase? max-words shrink-phrase))
  ([query phrase? max-words shrinker]
